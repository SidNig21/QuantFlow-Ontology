...
INSERT INTO schema_meta (type_name, kind, lifecycle, description) VALUES ('governed_review_task', 'action', 'experimental', 'Own the governed review Task lifecycle mutation for Kernel-internal admission and delivery.');
