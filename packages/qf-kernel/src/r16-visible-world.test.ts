...
function fixture() {
  ...
  const dataset = execute(db, "register_dataset_version", { kind: "results", purpose: "evaluation", artifact_id: sourceArtifact.object_id, content_hash: sourceArtifact.object_id, as_of: "2026-08-21T00:00:00.000Z", coverage: { deterministic_score_field: "edge" } }, trace);
