...
> [!warning] Superseded copy (v1.0). The doctrine lives in the repo: `~/QuantFlow-Ontology/docs/DOCTRINE.md` — now **v1.1** with amendments A1–A4 (2026-07-24: advisor-only, tower+Tailscale, charter-in-place, Coyle two gates, RL scope). This copy is kept for NotebookLM export (.html/.pdf beside it). **Do not edit here; edit the repo.**
