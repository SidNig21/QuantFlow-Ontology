...
const Watchtower = ({ embedded = false }) => {
  ...
  const events = [
    { t: '14:22:34.118', src: 'pi-scout',     lvl: 'info',  msg: 'l2 book Δ',         fields: { sym: 'BTC-PERP', spread: 0.5 } },
    { t: '14:22:34.219', src: 'pi-scout',     lvl: 'info',  msg: 'trade emitted',     fields: { sym: 'BTC-PERP', sz: '+0.143' } },
    { t: '14:22:34.281', src: 'pi-calculator',lvl: 'info',  msg: 'obs vector',        fields: { dim: 550, ts: 60 } },
    { t: '14:22:34.302', src: 'pi-policy',    lvl: 'info',  msg: 'inference',         fields: { action: 'LONG', conf: 0.58 } },
    { t: '14:22:34.305', src: 'hermes-gate',  lvl: 'info',  msg: 'pass=1 pattern',    fields: { verdict: 'APPROVE' } },
    { t: '14:22:34.308', src: 'hermes-gate',  lvl: 'info',  msg: 'pass=2 risk',       fields: { verdict: 'APPROVE' } },
    { t: '14:22:34.310', src: 'hermes-gate',  lvl: 'info',  msg: 'pass=3 verdict',    fields: { verdict: 'APPROVE', intent: '#a9c2' } },
    { t: '14:22:34.314', src: 'signer',       lvl: 'info',  msg: 'jwt verified',      fields: { exp: '60s' } },
    { t: '14:22:34.412', src: 'pi-executor',  lvl: 'info',  msg: 'fill',              fields: { sym: 'BTC-PERP', px: 67843.0, slip: '0.7bp' } },
    { t: '14:22:34.418', src: 'pi-executor',  lvl: 'info',  msg: 'dead-man refresh',  fields: { next: '30s' } },
    { t: '14:22:34.880', src: 'prime-train',  lvl: 'info',  msg: 'val sharpe',        fields: { sharpe: 1.12, liq: '1.8%' } },
    { t: '14:22:35.402', src: 'hermes-gate',  lvl: 'warn',  msg: 'pass=2 risk',       fields: { verdict: 'DOWNGRADE', size: '1.0→0.4' } },
  ];

  const cables = [
    { id: 'c1', from: 'pi-scout',  to: 'pi-calc',   depth: [2,4,3,6,5,7,4,5,3,2], peak: 12, kind: 'l2'  },
    { id: 'c2', from: 'pi-calc',   to: 'pi-policy', depth: [1,2,1,3,2,2,3,2,1,1], peak: 4,  kind: 'obs' },
    { id: 'c3', from: 'pi-policy', to: 'hermes',    depth: [0,1,0,2,1,1,0,1,0,0], peak: 2,  kind: 'act' },
    { id: 'c4', from: 'hermes',    to: 'executor',  depth: [0,1,0,1,0,2,1,0,0,1], peak: 2,  kind: 'jwt' },
    { id: 'c5', from: 'prime',     to: 'tboard',    depth: [3,5,4,7,6,8,9,7,8,6], peak: 14, kind: 'scalar' },
  ];

  const agents = [
    { id: 'scout',     name: 'pi-scout',         status: 'running', rps: 2.4, last: '0.1s',  load: [4,7,5,8,6,9,7,8,6,7] },
    { id: 'calc',      name: 'pi-calculator',    status: 'running', rps: 2.4, last: '0.0s',  load: [3,5,4,6,5,7,5,6,4,5] },
    { id: 'policy',    name: 'pi-policy',        status: 'running', rps: 1.8, last: '0.2s',  load: [2,3,4,2,3,4,3,4,3,2] },
    { id: 'gate',      name: 'hermes-gate',      status: 'running', rps: 1.6, last: '0.3s',  load: [1,2,1,2,3,2,2,1,2,2] },
    { id: 'exec',      name: 'pi-executor',      status: 'running', rps: 1.2, last: '0.4s',  load: [1,1,2,1,2,1,2,2,1,1] },
    { id: 'prime',     name: 'prime-train',      status: 'running', rps: 0.0, last: '4.2s',  load: [9,8,9,9,8,9,9,9,8,9] },
  ];
...
const AlertList = () => (
  <div style={{ padding: '10px 14px' }}>
    <div style={{
      ...
      background: 'oklch(0.78 0.14 80 / 0.06)', border: '1px solid oklch(0.78 0.14 80 / 0.3)',
      borderRadius: 7,
    }}>
      <span style={{
        width: 6, height: 6, borderRadius: '50%', background: 'oklch(0.78 0.14 80)',
        boxShadow: '0 0 6px oklch(0.78 0.14 80)', marginTop: 7, flexShrink: 0,
      }} />
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 12, color: '#e7ecf2', fontWeight: 500, marginBottom: 2 }}>hermes-gate DOWNGRADE · pass=2 risk · BTC-PERP size 1.0→0.4</div>
        <div style={{ fontFamily: 'Geist Mono, monospace', fontSize: 10.5, color: '#8a96a6' }}>14:22:35.402 · intent#a9c2 · logged to vault/verdicts/</div>
      </div>
      <button style={{
