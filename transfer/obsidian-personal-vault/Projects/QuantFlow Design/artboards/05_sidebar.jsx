  ...
  const chains = [
    {
      id: 'trading',
      name: 'Trading loop',
      hint: 'scout → calc → policy → hermes → executor',
      tiles: [
        { id: 'scout',  kind: 'term',    host: 'agents/', name: 'pi-scout',        status: 'running' },
        { id: 'calc',   kind: 'agent',   host: 'agents/', name: 'pi-calculator',   status: 'running' },
        { id: 'policy', kind: 'agent',   host: 'agents/', name: 'pi-policy',       status: 'running' },
        { id: 'gate',   kind: 'agent',   host: 'agents/', name: 'hermes-gate',     status: 'running' },
        { id: 'exec-main', kind: 'term', host: 'agents/', name: 'pi-executor',     status: 'running' },
        { id: 'signer', kind: 'term',    host: 'agents/', name: 'signer',          status: 'idle'    },
      ],
    },
    {
      id: 'training',
      name: 'Training',
      hint: 'prime intellect · pufferlib ppo',
      tiles: [
        { id: 'prime',  kind: 'term', host: 'training/', name: 'prime-train',      status: 'running' },
    ...
    },
    {
      id: 'monitor',
      name: 'Monitoring',
      hint: 'wrangler tail · supervisor',
      tiles: [
        { id: 'wrangler', kind: 'term', host: 'ops/',  name: 'wrangler tail',      status: 'running' },
        { id: 'watch',   kind: 'term', host: 'ops/', name: 'supervisor',           status: 'running' },
        { id: 'alerts',  kind: 'note',  host: 'vault/', name: 'verdicts.md',       status: 'error'   },
      ],
    },
    {
      id: 'scratch',
      ...
      hint: '/mnt/c/.../genome',
      tiles: [
        { id: 'eq',    kind: 'data',    host: 'vault/', name: 'btc-perp.pnl',     status: 'idle' },
        { id: 'notes', kind: 'note',    host: 'vault/', name: 'integration.md',   status: 'idle' },
      ],
    },
  ];
