...
> Architecture center. Free-tier: orientation only. Apollo/Rubix = infra under your enrollment — you do not operate them.
...
- 
- 
- The Multimodal Data Plane • Palantir 
- 
- 
- 
- 
...
- Documentation 
- Apollo 
- Gotham Search documentation Search karat +

 K

 API Reference ↗ Send feedback en en jp kr zh AB XY AB XY AB XY AB XY AB XY AB XY AB XY 
- Capabilities 
- AI Platform (AIP) 
...
- Platform updates 
- Announcements 
- Release notes Architecture center The Multimodal Data Plane 
# Multimodal Data Plane (MMDP)
...
## Anywhere: MMDP's commitment to openness
 ...
 ← PREVIOUS The Ontology system NEXT Interoperability → © 2026 Palantir Technologies Inc. All rights reserved.

 Cookies Statement ↗ Privacy Statement ↗ Terms of Use ↗ Cookie Settings
