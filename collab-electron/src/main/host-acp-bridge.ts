/**
 * Host-bridged ACP (WO-008c) — spawn a host ACP stdio agent (e.g. `hermes acp`),
 * complete initialize + session/new, never prompt.
 *
 * Deny-by-default on permission requests (WO-008a will own the UI). Do not revive
 * legacy acp-agent.ts auto-approve.
 */
