...
The public README describes the accepted Golden product and repository as they exist on `main` after Phase 3. It does not present old screenshots, QA-only inventory, superseded Golden status, or frozen future rungs as current capability.
...
- Current Golden designation, real founder walkthrough, production Dock inventory, packaging status, and honest limits match accepted evidence.
- Historical screenshots and design references are not presented as the current installed product.
