...
reader_authority: **REOPENED FOR ONE BOUNDED FOUR-DEFECT AMENDMENT ONLY**
independent_verifier_verdict: **FAIL — four finite defects; no other assertion reopened**
independent_verifier_evidence_head: `2b5e50e2d59e1025d54ac95ae13dc4fa009b26e8`
independent_verifier_evidence_tree: `99c7bfd2f0df79a5e9d4f4e85aa5144603eda2a5`
...
## Frozen Builder surface and starting matrix — suspended pending amendment

The prior Reader-approved Builder surface starts from authority
`baedcecd55b91dc3c5d951f969a2111d5cedf4d2`, tree
`33695d1ac5a53b56077bbf739d94e6e230d6533b`. It remains frozen evidence, but
Builder authority is suspended by the independent Verifier FAIL recorded in
`READER-ACCEPTANCE.md` and `VERIFIER-ACCEPTANCE.md`. If reauthorized, the
allowed surface is the exact
...
The final Reader recorded `YES / YES` for the prior order, but the independent
Verifier then returned `FAIL` on the four finite defects above. No G8 Builder
is open until the same semantic Reader accepts the bounded amendment; later
