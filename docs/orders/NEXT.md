# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 LOCAL CABLE BUILDER

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 AUTHORITY `eafbabfa` / PRESERVED PRE-R18 PROOF / LOCAL CABLE TWO-FILE BUILDER OPEN / R18 CLOSED
...
builder-authority: **OPEN ONLY FOR THE EXACT LOCAL CABLE AMENDMENT — Reader task `01a05212-f0e4-7101-a0d9-8e59df8a3f08` returned YES / YES on commit `eafbabfa85db1b8041b021d90b5dc0936f1271bf` / tree `c34532e8aa75f834b0311942e1b084f3f12b28e1`; editable paths are only `collab-electron/src/windows/shell/src/research-world.js` and `collab-electron/src/windows/shell/src/research-world.test.ts`; existing `qa/gates/pre-r18-coherence.ts` proof is bound unchanged at blob `493dfa080ca814e66e391f8e1b985ce8c30baff9` / diff `53bdb1c32ced5e1995f1357d98406c0ca35c10a0`; all other paths and meanings remain CLOSED**
router-authority: **CLOSED DURING THIS FINITE TWO-FILE BUILDER — any gate-proof byte change, third editable path, changed membership/opacity meaning, or new defect returns to a fresh Reader**
...
phase3-status: **ACCEPTED AUTHORITY `eafbabfa85db1b8041b021d90b5dc0936f1271bf` / LOCAL CABLE TWO-FILE BUILDER OPEN AGAINST EXACT PRESERVED PRE-R18 PROOF — parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
