# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 VIEW-STATE MECHANICAL RESUME

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `b30e1762` / PRESERVED P13/P16 GATE DIFF / ONE-ARGUMENT MECHANICAL RESUME OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME ONLY THE PRESERVED UNSTAGED `qa/gates/pre-r18-coherence.ts` VIEW-STATE DIFF PLUS ONE MECHANICAL ARGUMENT CORRECTION — pass `expectedCurrentMissionIds` rather than `expectedDefaultIds` to `defaultReceiptExpression`; literal exact 17 current-Mission IDs, 13 primary stages, 12 primary cables, historical/FULL leakage excluded; existing five navigation plus membership/cable/stage/historical baits required; no semantic Reader required**
router-authority: **CLOSED DURING THIS PRESERVED ONE-FILE RESUME — no second path, product/test/oracle data change, count-only proof, changed membership, or other correction is authorized**
...
phase3-status: **BASE `b30e17626436bbde81c378338f452fed0bcdb06d` / PRESERVED P13/P16 VIEW-STATE DIFF MAY RESUME WITH ONE ARGUMENT FIX — parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
