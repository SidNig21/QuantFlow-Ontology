# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 DOCK REFRESH READER REQUIRED

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 SOURCE `4c9964df` PRESERVED / DOCK REFRESH AMENDMENT READER REQUIRED / BUILDER CLOSED / R18 CLOSED
...
builder-authority: **CLOSED — the proposed three-file Dock refresh-coordination amendment requires a fresh Reader YES / YES and separate receipt/rotation; no product, test, gate, or execution mutation is authorized at this commit**
router-authority: **OPEN FOR THIS FRESH PHASE-3 DOCK-REFRESH AMENDMENT RECHECK ONLY — no product, test, gate, capture, analyzer, candidate, Golden, R18, or unrelated mutation is authorized**
...
phase3-status: **SOURCE `4c9964dff57b08c9b9d3d39c6e0bafa37a7721e6` PRESERVED / DOCK REFRESH-COORDINATION AMENDMENT READER PENDING / BUILDER CLOSED — no candidate until P01-P17 are green**
...
phase3-dock-refresh-amendment: [proposed three-file refresh authority](evidence/golden-baseline/phase3/PHASE3-DOCK-REFRESH-COORDINATION-AMENDMENT-20260830.md) — **FRESH READER RECHECK REQUIRED / BUILDER CLOSED; coalesced single-flight refresh, pending invalidation, complete snapshots only, newest pass wins, failure recovery/no storm; same-ID closed/stopped/completed/restartable invariant unchanged**
