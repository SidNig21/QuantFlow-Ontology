# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 P15 RESPONDER REPAIR

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `c168bdbc` / PRESERVED AUTHORIZED DIRTY SET / P15 RESPONDER TWO-FILE REPAIR OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME THE EXISTING AUTHORIZED EIGHT-PATH DIRTY SET AND ADD ONLY `collab-electron/cli/qf-hermes-synthetic-responder.mjs` PLUS `collab-electron/cli/qf-hermes-synthetic-responder.test.ts` — fresh Reader task `01a05212-f0e4-7101-a0d9-8e59df8a3f08` adjudicated a real P15 QA responder regression; `nextReview` accepts exact parsed `qf.task.second_opinion.v1` as `{secondOpinion: delivery}`, otherwise unchanged strict `parseCriticMission`; exact review-id ack and malformed/wrong/raw rejection required; gate/timeouts/Main/Kernel/peer identity unchanged**
router-authority: **CLOSED DURING THIS FINITE P15 RESPONDER REPAIR — no third new executable path, gate/timeout/Main/Kernel/product/peer change, loose parser, raw governed-review shortcut, or different correction is authorized**
...
phase3-status: **BASE `c168bdbc2a4262460f9bb7d5aabd4141b65b77a5` / EXISTING AUTHORIZED DIRTY SET PLUS TWO-FILE P15 SYNTHETIC-RESPONDER REPAIR OPEN — P14-A parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
