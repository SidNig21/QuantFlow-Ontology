# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 VIEW-STATE GEOMETRY RESUME

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `40f2eaa7` / PRESERVED P13/P16 GATE DIFF / STAGE-GEOMETRY MECHANICAL RESUME OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME ONLY THE PRESERVED UNSTAGED `qa/gates/pre-r18-coherence.ts` VIEW-STATE DIFF — keep all 17 visible tiles for membership/readability/non-overlap/obstruction/unknown checks; derive exact 13 deduped stage IDs/rects for unchanged width `[.70,.85]`, height `[.45,.70]`, and `136px` floor; `runDefaultMutationMatrix` receives `expectedCurrentMissionIds`; exact 17 objects/13 stages/12 cables and all navigation/membership/cable/stage/historical/layout baits remain required; no semantic Reader required**
router-authority: **CLOSED DURING THIS PRESERVED ONE-FILE RESUME — no second path, product/layout/oracle data change, threshold change, count-only proof, changed membership, or other correction is authorized**
...
phase3-status: **BASE `40f2eaa7e9c06d1e430cb057539f82d5e1341f54` / PRESERVED P13/P16 VIEW-STATE DIFF MAY RESUME WITH MECHANICAL STAGE-GEOMETRY CORRECTION — parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
