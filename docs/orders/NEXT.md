# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 P14-A PARSER REPAIR

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `8b74807c` / PRESERVED AUTHORIZED DIRTY SET / P14-A COUPLED-TUPLE PARSER CORRECTION OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME THE EXISTING AUTHORIZED FOURTEEN-PATH DIRTY SET; PARSER WORK REMAINS ONLY `tools/qf-bovada-football/src/parser.ts` PLUS `tools/qf-bovada-football/src/parser.test.ts` — recognize only contiguous coupled tuple A `SPORT/FOOT/Football→LEAGUE/241/NFL` or tuple B `LEAGUE/241/NFL→SPORT/1/Football`; return same semantics; both cross combinations rejected; no cross-product/sort/set/independent search; zero noncandidate, multiple-window ambiguity, structural SchemaError; ten categories then one final live capture; later predicates unchanged**
router-authority: **CLOSED DURING THIS FINITE P14-A COUPLED-TUPLE CORRECTION — no third path, fixture/runner/Kernel/schema change, cross-product, additional tuple/alias, loose matching, later-predicate change, second chase capture, raw payload, or acceptance reclassification is authorized**
...
phase3-status: **BASE `8b74807cd4d6ec033aaa05fd5462cbcd74c11cc3` / EXISTING AUTHORIZED DIRTY SET PLUS TWO-FILE P14-A COUPLED-TUPLE CORRECTION OPEN — one final fresh live proof required and P14-A remains RED absent exact admission; no candidate until P01-P17 are green**
