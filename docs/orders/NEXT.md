...
status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 CURRENT FOUNDER-PATH REPAIR OPEN / P14-B RED / R18 CLOSED
...
builder-authority: **OPEN ONLY FOR [the accepted current-product founder-path correction](evidence/golden-baseline/phase3/PHASE3-FOUNDER-PATH-CURRENT-PRODUCT-CORRECTION-20260830.md) at authority `79456a01`; use only its finite Builder-owned file list and exact F01–F07 meanings; no product file outside that list, schema, ontology, provider/model, credential, Bovada, R18, premium redesign, or acceptance weakening**
