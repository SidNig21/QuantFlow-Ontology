# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 P15 HOLD-LIFECYCLE REPAIR

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `d8e2f0e7` / PRESERVED AUTHORIZED DIRTY SET / P15 HOLD-LIFECYCLE TWO-FILE REPAIR OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME THE EXISTING AUTHORIZED TEN-PATH DIRTY SET; NEW WORK REMAINS ONLY IN `collab-electron/cli/qf-hermes-synthetic-responder.mjs` AND `collab-electron/cli/qf-hermes-synthetic-responder.test.ts` — in steering hold, after readiness use `await consumeDeliveries(reader); return`; only normal research may background-consume with its tool turn; exact assignment/steering/second-opinion contracts, IDs, 15s gate timeout, worker2/critic tests, Main/Kernel/peer identity remain unchanged; pushable-reader proof requires two exact acks, malformed none, close settles**
router-authority: **CLOSED DURING THIS FINITE P15 HOLD-LIFECYCLE REPAIR — no third path, gate/timeout/Main/Kernel/product/peer change, sleep, loose text, extra consumer, swallowed failure, or different correction is authorized**
...
phase3-status: **BASE `d8e2f0e764c602592b2da383882b93b9d3bc8719` / EXISTING AUTHORIZED DIRTY SET PLUS TWO-FILE P15 STEERING-HOLD OWNED-LOOP REPAIR OPEN — P14-A parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
