# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 PRE-R18 HASH REPAIR

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 SOURCE `b028c84a` PRESERVED / ONE-FILE MECHANICAL HASH REPAIR OPEN / R18 CLOSED
...
builder-authority: **OPEN ONLY FOR ONE MECHANICAL PIN UPDATE IN `qa/gates/pre-r18-coherence.ts` — replace stale expected SHA `b5daf9ac...` with exact accepted oracle SHA `2a22656bb86f3c3301d5c236aecc73b67a31d3bd93c56853a0a0e3418eaaed64`; focused old-RED/new-GREEN hash proof required; then resume P13/P16, P15, and measurement-only P14-A; no semantic Reader required**
router-authority: **CLOSED DURING THIS ONE-FILE MECHANICAL BUILDER — any oracle/assertion/product/timing/fixture/meaning change or second executable path stops and requires new authority**
...
phase3-status: **ACCEPTED SOURCE `b028c84a63e23f8d0393fad5adebc5531048d645` / PRE-R18 STALE ORACLE-HASH CONSUMER MECHANICAL REPAIR OPEN — parser and candidate/Golden remain closed; no candidate until P01-P17 are green**
