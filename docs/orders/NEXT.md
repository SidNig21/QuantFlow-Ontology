...
status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 BASE `fa3c5a26` / PRESERVED AUTHORIZED DIRTY SET / P14-A TWO-FILE PARSER REPAIR OPEN / R18 CLOSED
...
builder-authority: **OPEN TO RESUME THE EXISTING AUTHORIZED TWELVE-PATH DIRTY SET AND ADD ONLY `tools/qf-bovada-football/src/parser.ts` PLUS `tools/qf-bovada-football/src/parser.test.ts` — exact adjacent same-parent SPORT Football with ID `FOOT|1` immediately followed by LEAGUE `241/NFL`, case-sensitive; zero noncandidate, multiple ambiguity, missing/non-string SchemaError; event competition 241 and every later predicate unchanged; ten-case mutation matrix then one fresh live capture; normal success only on exact unchanged admission**
router-authority: **CLOSED DURING THIS FINITE P14-A PARSER REPAIR — no third path, fixture/runner/Kernel/schema change, additional alias, loose matching, later-predicate change, second chase capture, raw payload, or acceptance reclassification is authorized**
...
phase3-status: **BASE `fa3c5a26265f61934cc49d5b8616cea13580392a` / EXISTING AUTHORIZED DIRTY SET PLUS TWO-FILE P14-A ADJACENCY/ALIAS PARSER REPAIR OPEN — fresh live proof required and P14-A remains RED absent exact admission; no candidate until P01-P17 are green**
...
phase3-p14-a-parser-adjacency: [Reader-adjudicated two-file parser authority](evidence/golden-baseline/phase3/PHASE3-P14-A-PARSER-ADJACENCY-AUTHORITY-20260830.md) — **completed tuple adjudication; preserve FOOT and add only measured ID 1; exact adjacent SPORT Football→LEAGUE 241/NFL; zero/multiple/schema classes exact; all later predicates unchanged; ten-case mutations plus one fresh live proof**
