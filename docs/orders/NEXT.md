# NEXT — R18 GOLDEN BASELINE / PHASE 2 CLOSED / PHASE 3 DOCK REFRESH BUILDER

status: G1–G12 CLOSED / PHASE 2 ACCEPTED / PHASE 3 SOURCE `4c9964df` PRESERVED / DOCK REFRESH THREE-FILE BUILDER OPEN / R18 CLOSED
...
builder-authority: **OPEN ONLY FOR THE EXACT DOCK REFRESH AMENDMENT — Reader task `01a05212-f0e4-7101-a0d9-8e59df8a3f08` returned YES / YES on commit `b1f508e13e5b4db207ca03eefddd32c84bd66aa8` / tree `a142bdbdb722195af87071fc8fd600ac568c169c`; editable paths are only `collab-electron/src/windows/shell/src/dock.js`, `collab-electron/src/windows/shell/src/dock.test.ts`, and proof surface in `qa/gates/pre-r18-coherence.ts`; oracle, other product, P14-A parser, P15-by-inference, P18/candidate/Golden, main/remotes, and R18 remain CLOSED**
router-authority: **CLOSED DURING THIS FINITE THREE-FILE BUILDER — any fourth path, changed meaning, oracle edit, or new defect returns to a fresh Reader**
...
phase3-status: **SOURCE `4c9964dff57b08c9b9d3d39c6e0bafa37a7721e6` PRESERVED / DOCK REFRESH-COORDINATION THREE-FILE BUILDER OPEN — no candidate until P01-P17 are green**
