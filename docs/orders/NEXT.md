...
builder-authority: **CLOSED pending one fresh semantic Reader YES / YES on [the bounded F01 projection amendment](evidence/golden-baseline/phase3/PHASE3-FOUNDER-PATH-CURRENT-PRODUCT-CORRECTION-20260830.md) at authority `6c0a4c78`; after YES / YES, reopen only for `task-delegation-projection.ts`, its unit test, and the two named gate readers; preserve candidate `295fa47d` F02-F07 bytes and all existing meanings; no other product file, schema, ontology, provider/model, credential, Bovada, R18, premium redesign, or acceptance weakening**
