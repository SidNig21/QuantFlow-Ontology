...
| [WO-008c](WO-008c.md) | Hermes host-bridged ACP (Outcome A outside guest exec) | **rework** — Outcome A host handshake accepted; D1 launch not in packed manifest; D2 ACP client triplicated | builder (Cursor) |
