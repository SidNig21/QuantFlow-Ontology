...
| [WO-103b](WO-103b.md) | The write path (2/2) — make the action surface honest before it is published | **open — current**; written 2026-07-26. Deletes the six dead actions (77 → 71 tools), rules on `connection`, closes debt #21, and adds the `observe-door` gate because debt #22's door opens on WO-104 by codegen | builder |
