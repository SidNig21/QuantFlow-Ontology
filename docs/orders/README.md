...
| [WO-104](WO-104.md) | The read plane — schema-driven reads, link traversal, MCP read server (P3 rung 1 of 3) | **open — current**; written 2026-07-26, pre-build read run. Serves **read tools only** so `qf_observe_ticket` stays unserved. Carries deliverable 0: the `observe-door` gate trusts a directory a tool server can hide in | builder |
