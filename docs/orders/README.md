...
| [WO-004a](WO-004a.md) | Proof correction: assert what is actually true | **rework** — verified 2026-07-18; 7 gates green cold, scope clean; one defect (D1, tautological `listedSessionId`) sent back | builder (Cursor) |
